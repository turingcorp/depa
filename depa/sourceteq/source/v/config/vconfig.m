...
-(instancetype)init:(cconfig*)controller
{
    ...
    [flow setSectionInset:UIEdgeInsetsMake(0, 0, 20, 0)];
...
{
    vconfigheader *reusable = [col dequeueReusableSupplementaryViewOfKind:kind withReuseIdentifier:headerid forIndexPath:index];
